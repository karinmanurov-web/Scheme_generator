...
def _rebuild_presentation(doc, stamp_data, log_callback=None):
    ...
    if frame_box and frame_box.has_data:
        stamp_x0 = frame_box.extmax.x - 185.0 * scale
        stamp_y0 = frame_box.extmin.y + 5.0 * scale
        # Notes sit above the stamp and outside the construction bbox.
        draw_notes_and_legend(msp, stamp_x0, stamp_y0 + 60.0 * scale, scale=scale)
